...
#
default.graylog2[:version]          = "0.20.0-rc.2"
default.graylog2[:server_tarball]   = "graylog2-server-#{node.graylog2[:version]}.tgz"
default.graylog2[:download_url]     = "https://github.com/Graylog2/graylog2-server/releases/download/#{node.graylog2[:version]}/#{node.graylog2[:server_tarball]}"
